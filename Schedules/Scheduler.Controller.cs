...
namespace gorevatamasureci_feyza.Schedulers.Controller
{
    [Route("apps/gorevatamasureci_feyza/latest/api/Scheduler/[action]")]
    [Route("apps/gorevatamasureci_feyza/{v:int:min(1)}/api/Scheduler/[action]")]
